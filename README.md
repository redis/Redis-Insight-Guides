...
On the root level of [statics](https://github.com/RedisInsight/RedisInsight/tree/main/redisinsight/ui/src/packages/enablement-area) folder, we have `enablement-area.json` and all necessary static files (markdowns, images, etc.)

The content of this area is generated based on Nodes specified inside `enablement-area.json`.
    ...
    "document": {
        ...
        "children": {
            "introduction": {
                ...
                "label": "Introduction",
                "args": {
                    "path": "/static/workbench/quick-guides/document/introduction.md"
                }
            },
            "learn-more": {
                "type": "internal-link",
...
```
## Pages
By using **"internal-link"** node we can open some [Markdown Guides](https://www.markdownguide.org/) located in [statics](https://github.com/RedisInsight/RedisInsight/tree/main/redisinsight/ui/src/packages/enablement-area) folder.
...
```
or relative path to image inside the [statics](https://github.com/RedisInsight/RedisInsight/tree/main/redisinsight/ui/src/packages/enablement-area)
```
![RedisInsight Browser screenshot](/static/workbench/_images/aggregations.png)
```
...
2. Approve guides release in CircleCI. In the background, new files will be loaded to Cloud Storage (AWS S3)
3. Reopen the Redisinsight with a working internet connection. In the background, new files will be downloaded to the user's local home directory:
    * **Mac**: In the `/Users/<your-username>/.redisinsight-preview/enablement-area` directory.
    * **Windows**: In the `C:\Users\<your-username>\.redisinsight-preview\enablement-area` directory.
    * **Linux**: In the `/home/<your-username>/.redisinsight-preview/enablement-area` directory.
...
enablament-area
 > quick-guides
   ...
   > streams
     basics.md
     getting-data.md
 enablement-area.json
```
5. Add new nodes inside `enablement-area.json`
```json
{
  "quick-guides": {
    "type": "group",
      ...
      "streams": {
        ...
        "children": {
          "basics": {
            ...
            "label": "Basics",
            "args": {
              "path": "/static/workbench/quick-guides/streams/basics.md"
            }
          },
          "get-data": {
            "type": "internal-link",
            ...
            "label": "Get Data",
            "args": {
              "path": "/static/workbench/quick-guides/streams/getting-data.md"
            }
          }
        }
      }
